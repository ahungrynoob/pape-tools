...
program.on('--help', () => {
  ...
  console.log();
  console.log('    $', 'pape-tools run lint'.to.magenta.color, 'lint source within lib');
  console.log('    $', 'pape-tools run pub'.to.magenta.color, 'publish component');
  // todo
  //   console.log(
  //     "    $",
  ...
  //     "start server"
  //   );
  console.log('    $', 'pape-tools run pretter'.to.magenta.color, 'pretter all code');
  // todo
  //   console.log(
  //     "    $",
